        ...
        <div className='footer'>
            <div className='footer-information'>
                ...
                <div className='footer-information-block'>
                    ...
                    <p className='footer-information-block-link'>euphoria Blog</p>
                    <p className='footer-information-block-link'>euphoriastan</p>
                    <p className='footer-information-block-link'>Collaboration</p>
                    <p className='footer-information-block-link'>Media</p>
                </div>
                <div className='footer-information-block'>
                    <h2 className='footer-information-block-name'>More Info</h2>
                    <p className='footer-information-block-link'>Term and Conditions</p>
                    <p className='footer-information-block-link'>Privacy Policy</p>
                    <p className='footer-information-block-link'>Shipping Policy</p>
                    <p className='footer-information-block-link'>Sitemap</p>
                </div>
                <div className='footer-information-block'>
                    <h2 className='footer-information-block-name'>Location</h2>
                    <p className='footer-information-block-link'>support@euphoria.in</p>
                    <p className='footer-information-block-link'>Eklingpura Chouraha, Ahmedabad Main Road</p>
                    <p className='footer-information-block-link'>(NH 8- Near Mahadev Hotel) Udaipur, India- 313002</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
